package com.byandev.fundametalandroid27.optimizationSqliteQuery.service
...
import com.byandev.fundametalandroid27.optimizationSqliteQuery.AppPreference
...
class DataManagerService : Service() , CoroutineScope {
    ...
    */
    ...
    private fun preLoadRaw(): ArrayList<MahasiswaModels> {
        val mahasiswaModels = ArrayList<MahasiswaModels>()
        var line: String?
        ...
        try {
            ...
            do {
                ...
                val mahasiswaModel: MahasiswaModels
