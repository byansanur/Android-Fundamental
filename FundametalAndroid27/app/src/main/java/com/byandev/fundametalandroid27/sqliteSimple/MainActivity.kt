...
//            loadNotesAsync()
//        } else {
//            val list = savedInstanceState.getParcelableArrayList<ContactsContract.CommonDataKinds.Note>(EXTRA_STATE)
//            if (list != null) {
...
//                        val note = data.getParcelableExtra<ContactsContract.CommonDataKinds.Note>(NoteAddUpdateActivity.EXTRA_NOTE)
